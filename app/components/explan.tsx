    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 max-w-6xl mx-auto">
      ...
      <BoxExpla bgCol="#000000" textCol="white">
        <div className="flex flex-col h-full p-6 space-y-6 items-center justify-center">
          <div className="relative h-32 w-32 md:h-40 md:w-40 mx-auto overflow-hidden rounded-full border-2 border-white/20">
            <Image
              src={FilmMaking}
              alt="Film making"
              fill
          ...
          <div className="text-center space-y-3">
            <h1 className="text-3xl font-bold tracking-wider">FILM WRITING</h1>
      ...
      <BoxExpla bgCol="#000000" textCol="white">
        <div className="flex flex-col h-full p-6">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-extrabold text-white">MEDIA</h1>
            <h3 className="text-lg font-medium text-white/80 italic">
      ...
      {/* Box 4 - Cinematic Arts */}
      <BoxExpla bgCol="#addbeb" textCol="white">
        <div className="flex flex-col h-full p-6 space-y-6 items-center justify-center">
          <div className="relative h-32 w-32 md:h-40 md:w-40 mx-auto overflow-hidden rounded-full border-2 border-white/20">
            <Image
              src={FilmMaking}
          ...
          <div className="text-center space-y-3">
            <h1 className="text-3xl font-bold tracking-wider">CINEMATIC ARTS</h1>
            <h3 className="text-lg font-light text-white/80 italic">
